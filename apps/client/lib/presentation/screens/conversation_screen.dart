...
class _ConversationScreenState extends State<ConversationScreen> {
  ...
  void initState() {
    ...
    _controller = ConversationController(
      ...
      teachingBrain: widget.teachingBrain,
  ...
  void _finishSession() {
    ...
    widget.completeSession.execute(
      result: result,
  ...
  Widget build(BuildContext context) {
    final state = _controller.state!;
    final showCorrection = state.corrections.isNotEmpty &&
        state.teachingStrategy.correctionTiming != CorrectionTiming.endOfSession;
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: SizedBox(width: double.infinity, child: OutlinedButton(onPressed: _finishSession, child: const Text('Finish session'))),
          ),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Card(child: Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const SizedBox(height: 6), Text(correction.explanation), const SizedBox(height: 4),
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isLearner ? Theme.of(context).colorScheme.primaryContainer : Theme.of(context).colorScheme.surfaceContainerHighest,
